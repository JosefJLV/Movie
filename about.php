    ...
    <div class="page">
      ...
      <header class="section page-header page-header-1 context-dark">
        <div class="page-header-1-figure m-parallax">
          <div class="page-header-1-image m-parallax-image" style="background-image: url(images/bg-image-2.jpg);"></div>
        </div>
        <!-- RD Navbar-->
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#">Movies</a>
                      <!-- RD Navbar Dropdown-->
                      <ul class="rd-menu rd-navbar-dropdown">
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="movies-1.html">Movies 1</a></li>
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="movies-2.html">Movies 2</a></li>
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="movies-3.html">Movies 3</a></li>
                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="movie-page.html">Movie Page</a></li>
                      </ul>
                    </li>
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Pages</a>
                      ...
                      <ul class="rd-menu rd-navbar-megamenu">
                        ...
                        <li class="rd-megamenu-item">
                          ...
                          <div class="rd-megamenu-block">
                            <ul class="rd-megamenu-list">
                              <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link" href="categories.html">Categories</a></li>
                  ...
                  <div class="rd-navbar-collapse" id="rd-navbar-collapse">
                    ...
                    <div class="swiper-container swiper-slider swiper-slider-pyramid" data-simulate-touch="false" data-direction="horizontal" data-slide-effect="coverflow">
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <article class="tour-minimal context-dark">
                            <div class="tour-minimal-inner" style="background-image: url(images/movie-3-img-04-258x273.jpg);">
                              <div class="tour-minimal-header">
                              </div>
                              <div class="tour-minimal-main">
                    ...
                    </div><a class="button button-default-outline" href="categories.html">View All Movies</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="breadcrumbs-custom-inner">
            <div class="container">
              <div class="breadcrumbs-custom-main m-parallax-content">
                ...
                <div class="group group-sm group-middle"><a class="button button-sm button-icon button-icon-left button-light" data-lightgallery="item" href="https://youtu.be/d5k9CILJivQ"><span class="icon mdi mdi-play"></span>Watch Now</a></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <div class="container">
          <div class="row row-50 justify-content-center align-items-center">
            <div class="col-md-10 col-lg-7">
              <h4 class="block-1 lh-1"> A Few Words About Flixena Streaming Service</h4>
              <div class="block-2 mt-20 mt-md-30 mt-lg-50">
                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
              </div><a class="button button-lg button-primary mt-lg-40" href="#">Read More</a>
            </div>
            <div class="col-md-10 col-lg-5 parallax-scene-js">
              <div class="section-image-1 v2"><img src="images/section-image-1-546x33.png" alt="" width="546" height="33"/>
      ...
      <!-- Features-->
      <section class="section section-lg bg-gray-900 context-dark text-center text-sm-start">
        <div class="container">
          <ul class="list-group-1 row row-50">
            <li class="col-sm-6 col-lg-3">
              <article class="lg-1-item">
                <div class="icon lg-1-item-icon linearicons-pictures"></div>
                <div class="lg-1-item-main">
                  <h5 class="lg-1-item-title"><span class="lg-1-item-counter"></span>Movie Photos</h5>
            ...
            <li class="col-sm-6 col-lg-3">
              <article class="lg-1-item">
                <div class="icon lg-1-item-icon linearicons-eye"></div>
                <div class="lg-1-item-main">
                  <h5 class="lg-1-item-title"><span class="lg-1-item-counter"></span>Detailed Reviews</h5>
            ...
            <li class="col-sm-6 col-lg-3">
              <article class="lg-1-item">
                <div class="icon lg-1-item-icon linearicons-3d-glasses"></div>
                <div class="lg-1-item-main">
                  <h5 class="lg-1-item-title"><span class="lg-1-item-counter"></span>Diverse Approach</h5>
            ...
            <li class="col-sm-6 col-lg-3">
              <article class="lg-1-item">
                <div class="icon lg-1-item-icon linearicons-camera-play"></div>
                <div class="lg-1-item-main">
                  <h5 class="lg-1-item-title"><span class="lg-1-item-counter"></span>Fresh Trailers</h5>
        ...
        <div class="range">
          <div class="cell-lg-7 cell-xl-8 cell-xxl-9">
            <div class="cell-inner section-lg text-center text-sm-start">
              ...
              <!-- Owl Carousel-->
              <div class="owl-carousel owl-1 mt-40 mt-lg-50" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="2" data-xl-items="3" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="30" data-mouse-drag="false">
                <!-- Profile Classic-->
                <article class="profile-classic"><img class="profile-classic-image" src="images/our-team-1-272x197.jpg" alt="" width="272" height="197"/>
                  <div class="profile-classic-main">
                    <p class="profile-classic-position">Founder, Owner</p>
                    <p class="profile-classic-name heading-5">Peter Jones</p>
                    <div class="profile-classic-unit">
                      <div class="icon mdi mdi-phone"></div><a href="tel:#">1-800-36-677</a>
                    </div>
                  </div>
                </article>
                <!-- Profile Classic-->
                <article class="profile-classic"><img class="profile-classic-image" src="images/our-team-2-272x197.jpg" alt="" width="272" height="197"/>
                  <div class="profile-classic-main">
                    <p class="profile-classic-position">Content Manager</p>
                    <p class="profile-classic-name heading-5">Leslie Alexander</p>
                    <div class="profile-classic-unit">
                      <div class="icon mdi mdi-phone"></div><a href="tel:#">1-800-36-677</a>
                    </div>
                  </div>
                ...
                <article class="profile-classic"><img class="profile-classic-image" src="images/our-team-3-272x197.jpg" alt="" width="272" height="197"/>
                  <div class="profile-classic-main">
                    <p class="profile-classic-position">Web Designer</p>
                    <p class="profile-classic-name heading-5">Mark Williams</p>
                    <div class="profile-classic-unit">
                      <div class="icon mdi mdi-phone"></div><a href="tel:#">1-800-36-677</a>
                    </div>
                  </div>
          ...
          <div class="cell-lg-5 cell-xl-4 cell-xxl-3 height-fill">
            <div class="box-3 bg-image" style="background-image: url(images/about-2.jpg);"><a class="box-3-play" data-lightgallery="item" href="https://youtu.be/d5k9CILJivQ"><span class="icon mdi mdi-play"></span></a></div>
          </div>
        </div>
      </section>
      <!-- Page Footer-->
